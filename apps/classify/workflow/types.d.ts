...
declare module "motia" {
  ...
  interface Handlers {
    "NormalizeIndicator": EventHandler<
      {
        indicator_id: string;
        name: string;
        units?: string;
    ...
    >;
    "FinalReview": EventHandler<
      {
        indicator_id: string;
        name: string;
        incorrect_fields: Array<string>;
    ...
    >;
    "CurrencyDenominationRouter": EventHandler<
      {
        indicator_id: string;
        name: string;
        description?: string;
      ...
      {
        topic: "indicator.assign-family-currency";
        data: {
          indicator_id: string;
          name: string;
          description?: string;
        ...
        topic: "indicator.route-by-unit-type";
        data: {
          indicator_id: string;
          name: string;
          description?: string;
    ...
    >;
    "AssignFamilyNonCurrency": EventHandler<
      {
        indicator_id: string;
        name: string;
        description?: string;
    ...
    >;
    "ClassifyTypeNonCurrency": EventHandler<
      {
        indicator_id: string;
        name: string;
        description?: string;
    ...
    >;
    "InferTimeBasisAndCumulativePattern": EventHandler<
      {
        indicator_id: string;
        name: string;
        description?: string;
    ...
    "StartClassify": ApiRouteHandler<
      ...
      ApiResponse<202, { message: string; count: number; trace_id: string }>,
      {
    ...
    >;
    "AssignFamilyCurrency": EventHandler<
      {
        indicator_id: string;
        name: string;
        description?: string;
    ...
    >;
    "ClassifyTypeCurrency": EventHandler<
      {
        indicator_id: string;
        name: string;
        description?: string;
