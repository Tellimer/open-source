...
const balanceIndicators: TestIndicator[] = [
  ...
  {
    id: "AUSGEDC",
    name: "GDP External Demand Contribution",
    indicator_type: "balance",
    is_currency_denominated: false,
    temporal_aggregation: "period-rate",
    value: 0.5,
  ...
  {
    id: "GGXONLB",
    name: "General government primary net lending/borrowing",
    indicator_type: "balance",
    is_currency_denominated: true,
    temporal_aggregation: "period-total",
    value: -50,
  ...
  {
    id: "GGSB",
    name: "General government structural balance",
    indicator_type: "balance",
    is_currency_denominated: true,
    temporal_aggregation: "period-total",
    value: -2.1,
  ...
  {
    id: "AFGHANISTAGOVBUDVAL",
    name: "Government Budget Value",
    indicator_type: "balance",
    is_currency_denominated: true,
    temporal_aggregation: "period-total",
    value: -500,
  ...
  {
    id: "GBRGTBNE",
    name: "Goods Trade Balance Non-EU",
    indicator_type: "balance",
    is_currency_denominated: true,
    temporal_aggregation: "period-total",
    value: -8.5,
  ...
  {
    id: "GGB",
    name: "General government balance",
    indicator_type: "balance",
    is_currency_denominated: true,
    temporal_aggregation: "period-total",
    value: -3.5,
...
const compositeIndexIndicators: TestIndicator[] = [
  ...
  {
    id: "JPNTCEFAE",
    name: "Tokyo CPI Ex Food and Energy",
    indicator_type: "index",
    is_currency_denominated: false,
    temporal_aggregation: "period-rate",
    value: 2.1,
  ...
  {
    id: "USADFMNOI",
    name: "Dallas Fed Manufacturing New Orders Index",
    indicator_type: "index",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: -5.2,
...
const countIndicators: TestIndicator[] = [
  ...
  {
    id: "RUSNWFA",
    name: "National Wealth Fund Assets",
    indicator_type: "count",
    is_currency_denominated: true,
    temporal_aggregation: "point-in-time",
    value: 150,
  ...
  {
    id: "TD_RESERVES_GFACB_LS_TJK_M",
    name: "Gross Foreign Assets (Central Bank)",
    indicator_type: "count",
    is_currency_denominated: true,
    temporal_aggregation: "point-in-time",
    value: 2.5,
  ...
  {
    id: "TD_RESERVES_FCANFRK_LS_KAZ_M",
    name: "Foreign Currency Assets Of The NFRK",
    indicator_type: "count",
    is_currency_denominated: true,
    temporal_aggregation: "point-in-time",
    value: 45.8,
  ...
  {
    id: "RUSNWFLA",
    name: "National Wealth Fund Liquid Assets",
    indicator_type: "count",
    is_currency_denominated: true,
    temporal_aggregation: "point-in-time",
    value: 120,
...
const flowIndicators: TestIndicator[] = [
  ...
  {
    id: "USAWCOP",
    name: "Weekly Crude Oil Production",
    indicator_type: "flow",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 13.2,
  ...
  {
    id: "CANIIFS",
    name: "Investment in Foreign Securities",
    indicator_type: "flow",
    is_currency_denominated: true,
    temporal_aggregation: "period-total",
    value: 12.5,
  ...
  {
    id: "AFGHANISTAGDPFROCON",
    name: "GDP from Construction",
    indicator_type: "flow",
    is_currency_denominated: true,
    temporal_aggregation: "period-total",
    value: 25,
...
const indexIndicators: TestIndicator[] = [
  {
    id: "USAKFSI",
    name: "Kansas Fed Shipments Index",
    indicator_type: "index",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 15.3,
  ...
  {
    id: "USACPCAHI",
    name: "CFNAI Personal Consumption and Housing Index",
    indicator_type: "index",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 0.25,
...
const percentageIndicators: TestIndicator[] = [
  ...
  {
    id: "ALBANIASOCSECRATFORC",
    name: "Social Security Rate For Companies",
    indicator_type: "percentage",
    is_currency_denominated: false,
    temporal_aggregation: "point-in-time",
    value: 15.5,
  ...
  {
    id: "CHNRRRFFS",
    name: "Risk Reserve Ratio Forward FX Sales",
    indicator_type: "percentage",
    is_currency_denominated: false,
    temporal_aggregation: "point-in-time",
    value: 20,
  ...
  {
    id: "ALBANIASOCSECRATFORE",
    name: "Social Security Rate For Employees",
    indicator_type: "percentage",
    is_currency_denominated: false,
    temporal_aggregation: "point-in-time",
    value: 11.2,
...
const priceIndicators: TestIndicator[] = [
  ...
  {
    id: "UNITEDSTASFHP",
    name: "Single Family Home Prices",
    indicator_type: "price",
    is_currency_denominated: true,
    temporal_aggregation: "point-in-time",
    value: 425,
...
const rateIndicators: TestIndicator[] = [
  ...
  {
    id: "BELNPCRY",
    name: "New Passenger Car Registrations YoY",
    indicator_type: "rate",
    is_currency_denominated: false,
    temporal_aggregation: "period-rate",
    value: -5.3,
...
const ratioIndicators: TestIndicator[] = [
  ...
  {
    id: "PFX_LS_LBN_LBP",
    name: "Lebanon Parallel FX Rate (LBP)",
    indicator_type: "ratio",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 95000,
  ...
  {
    id: "JAPANJTAR",
    name: "Jobs To Applications Ratio",
    indicator_type: "ratio",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 1.28,
  ...
  {
    id: "PFX_LS_NGA_NGN",
    name: "Nigeria Parallel FX Rate (NGN)",
    indicator_type: "ratio",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 1500,
  ...
  {
    id: "NGDPDPC",
    name: "GDP per Capita at Current Prices, USD",
    indicator_type: "ratio",
    is_currency_denominated: true,
    temporal_aggregation: "point-in-time",
    value: 52000,
  ...
  {
    id: "PPPPC",
    name: "GDP per Capita at Current Prices, PPP",
    indicator_type: "ratio",
    is_currency_denominated: true,
    temporal_aggregation: "period-total",
    value: 55000,
...
const ratioProportionIndicators: TestIndicator[] = [
  ...
  {
    id: "UFX_WB_IRQ_IQD",
    name: "Iraq Alternative Official FX Rate Rate (IQD)",
    indicator_type: "ratio",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 1320,
  ...
  {
    id: "BRAMMIRY",
    name: "Mid-month Inflation Rate YoY",
    indicator_type: "ratio",
    is_currency_denominated: false,
    temporal_aggregation: "period-rate",
    value: 4.5,
  ...
  {
    id: "UFX_WB_GMB_GMD",
    name: "Gambia, The Alternative Official FX Rate Rate (GMD)",
    indicator_type: "ratio",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 68,
  ...
  {
    id: "GBROIAR",
    name: "Overnight Interbank Average Rate",
    indicator_type: "ratio",
    is_currency_denominated: false,
    temporal_aggregation: "period-average",
    value: 5.2,
...
const stockIndicators: TestIndicator[] = [
  ...
  {
    id: "UNITEDSTAAPIHEAOIL",
    name: "API Heating Oil",
    indicator_type: "stock",
    is_currency_denominated: false,
    temporal_aggregation: "point-in-time",
    value: 110,
  ...
  {
    id: "DT.DOD.DPNG.CD",
    name: "Private sector not guaranteed",
    indicator_type: "stock",
    is_currency_denominated: true,
    temporal_aggregation: "point-in-time",
    value: 450,
  ...
  {
    id: "TD_RESERVES_NFACB_LS_AGO_M",
    name: "Net Foreign Assets (Central Bank)",
    indicator_type: "stock",
    is_currency_denominated: true,
    temporal_aggregation: "point-in-time",
    value: 12.5,
...
async function testIndicatorBatch(
  ...
  console.log(
    `${typeName}: ${result.successful.length}/${indicators.length} successful (${
  ...
  if (result.failed.length > 0 || result.skipped.length > 0) {
    ...
    result.skipped.forEach((skipped) => {
      console.log(
        `    Skipped: ${skipped.item.id} - ${skipped.item.name} (${skipped.item.unit})`,
      );
    });
  }
  ...
  assertEquals(
    ...
    `At least ${
      minSuccess * 100
    }% of ${typeName} indicators should process successfully, got ${
      (successRate * 100).toFixed(1)
    }%`,
  );
  ...
  result.successful.forEach((item, idx) => {
    assertExists(
      item.normalized,
      `${typeName}[${idx}] should have normalized value`,
    );
  });
}
...
Deno.test("Comprehensive - INDEX indicators from composite-derived/index (9 total)", async () => {
  await testIndicatorBatch(
    compositeIndexIndicators,
    "index (from composite-derived/index)",
  );
});
...
Deno.test("Comprehensive - ALL 150 indicators together", async () => {
  ...
  assertEquals(
    allIndicators.length >= 149,
    true,
    `Should have at least 149 indicators, got ${allIndicators.length}`,
  );
  ...
  console.log(
    `Processed ${result.successful.length}/${allIndicators.length} successfully`,
  );
  console.log(
    `Failed: ${result.failed.length}, Skipped: ${result.skipped.length}`,
  );
  ...
  assertEquals(
    successRate > 0.9,
    true,
    `Success rate should be >90%, got ${(successRate * 100).toFixed(1)}%`,
  );
});
