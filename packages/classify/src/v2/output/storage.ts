...
export function writeClassifications(
  ...
  for (const cls of classifications) {
    stmt.run(
      ...
      cls.source_name || null,
      cls.long_name || null,
      cls.category_group || null,
      cls.dataset || null,
      cls.topic || null,
      cls.scale || null,
      cls.periodicity || null,
      cls.aggregation_method || null,
      cls.currency_code || null,
      cls.sample_values ? JSON.stringify(cls.sample_values) : null,
      cls.family,
